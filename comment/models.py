...
class comment(models.Model):
    ...
    comment_related_user = models.ForeignKey(User, related_name="comments", on_delete=models.CASCADE)
    related_post = models.ForeignKey(add_post, related_name="comments", on_delete=models.CASCADE)
